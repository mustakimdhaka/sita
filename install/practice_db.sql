...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2017 at 08:47 AM
...
(15, 7, 2, '2017-11-19', 3, 'pending'),
(16, 14, 2, '2017-11-20', 2, 'pending'),
(17, 17, 2, '2017-11-20', 1, 'pending');
...
INSERT INTO `product` (`id`, `name`, `brand`, `price`, `available`) VALUES
(2, 'Xperia XZII', 'Sony', 23000, 'yes'),
(3, 'Primo H2', 'Walton', 18500, 'no'),
(4, 'Galaxy S', 'Samsung', 18500, 'no'),
(5, 'Roar V25', 'Symphony', 5500, 'no'),
(6, 'HM mini', 'Walton', 13500, 'yes'),
(7, 'X2 Gold', 'Nokia', 9000, 'yes'),
(8, 'Galaxy Note', 'Samsung', 21000, 'yes'),
(9, 'Galaxy S Duos', 'Samsung', 23000, 'yes'),
(10, 'GF2', 'Walton', 13000, 'yes'),
(11, 'Bold 9800', 'Blackberry', 14490, 'yes'),
(12, 'G6 Supreme', 'LG', 42750, 'no'),
(13, 'Redmi Note 3', 'Xiaomi', 16790, 'yes'),
(14, 'Cybershot C905', 'Sony', 8990, 'yes'),
(15, 'Torch 8900', 'Blackberry', 12300, 'yes'),
(16, 'i10', 'Symphony', 8900, 'yes'),
(17, 'P6 Pro', 'Symphony', 12200, 'yes');
